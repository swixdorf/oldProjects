...
void YeniIndexYap();
extern DWORD dwINDX;	// hadi bunu da yakalasana?
extern bool bOtur;
...
bool __stdcall ProcessRecva(DWORD DataPack,int &iOffset);	//virtual hook
...
__declspec(naked)swx_send_hook();
...
inline bool CheckLoading(){
if(*(DWORD*)(*(DWORD*)(KO_CHAR) + KO_MYID) == 0)
return true;
else
return false;
//return (bool)(!*(DWORD*)(*(DWORD*)(KO_DLGA) + 0x508));
};
...
extern BYTE	pBuf_BuffSelf1[26];
extern BYTE	pBuf_BuffSelf2[26];
extern BYTE pBuf_RemoveSelf[26];

extern BYTE	pBuf_Attack1[26];
extern BYTE	pBuf_Attack2[22];
extern BYTE	pBuf_Attack3[26];
extern BYTE	pBuf_Attack4[26];

extern BYTE	pBuf_FakeSkill[26];
...
__published:	// IDE-managed Components
	...
	TCheckBox *chformsize;
	TPopupMenu *protaedit;
	TMenuItem *duzenle1;
	TMenuItem *sil1;
	TPanel *Panel1;
	TCheckBox *charchery;
	...
	TCheckBox *chMinPartyMember;
	TEdit *txtMinPartyCount;
	TCheckBox *chtownonpri;
	...
	TCheckBox *chks;
	TCheckBox *chokcudcfix;
	TTimer *tmservercheck;
	TEdit *Edit1;
	TButton *Button18;
	TButton *Button19;
	TCheckBox *chExpFlash;
	TCheckBox *chDcFlash;
	TTimer *flashtimer;
	TButton *f_ref;
	TButton *Button20;
	TButton *Button21;
	TCheckBox *chdontmoveondie;
	TTimer *Timer1;
	TCheckBox *CheckBox3;
	TCheckBox *CheckBox4;
	TCheckBox *CheckBox5;
	...
	void __fastcall chPartyBaskanAtackClick(TObject *Sender);
	void __fastcall chformsizeClick(TObject *Sender);
	void __fastcall Button4Click(TObject *Sender);
	void __fastcall btnjailClick(TObject *Sender);
	void __fastcall sil1Click(TObject *Sender);
	void __fastcall duzenle1Click(TObject *Sender);
	void __fastcall chMinPartyMemberClick(TObject *Sender);
	void __fastcall chtownonpriClick(TObject *Sender);
	void __fastcall chokcudcfixClick(TObject *Sender);
	void __fastcall chringondcClick(TObject *Sender);
	void __fastcall chcloseondcClick(TObject *Sender);
	...
	void __fastcall tyontimerTimer(TObject *Sender);
	void __fastcall Button12Click(TObject *Sender);
	void __fastcall hallowen2Timer(TObject *Sender);
	void __fastcall hstimerTimer(TObject *Sender);
	void __fastcall hallowenTimer(TObject *Sender);
	void __fastcall prepareForms(TObject *Sender);
	void __fastcall prepareSkillCodes(TObject *Sender);
	void __fastcall prepareMenu(TObject *Sender);
	void __fastcall switchasasClick(TObject *Sender);
	void __fastcall tmservercheckTimer(TObject *Sender);
	void __fastcall Button18Click(TObject *Sender);
	void __fastcall chExpFlashClick(TObject *Sender);
	void __fastcall chDcFlashClick(TObject *Sender);
	void __fastcall f_refClick(TObject *Sender);
	void __fastcall flashtimerTimer(TObject *Sender);
	void __fastcall Button20Click(TObject *Sender);
	void __fastcall chdontmoveondieClick(TObject *Sender);
	...
	void __fastcall chhammerClick(TObject *Sender);
...
public:		// User declarations
	...
	DWORD dwLastFlashTimer;
	BYTE LastFlashLevel;
	bool bFlashBas;
	bool bFlashExp;
	bool bFlashDc;
	bool bHammer;
	DWORD LastHammerTick;
		float xx,yy;
		bool otuzucellialti;
		bool otuzuconsekiz;
		bool skillbug;
		bool bdontmoveondie;
		bool bdied;
		WORD TarancakIdler[20];
		DWORD shWait;
		bool extendedsavecpu;
		bool buypazarblock;
		DWORD P41Timer;
