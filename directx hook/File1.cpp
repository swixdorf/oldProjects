...
const DWORD Kontrol=0x0092B64E;//ok
const DWORD KotrolDeger=0x92a98068;
const DWORD KODEVAM= 0x0092B724;//ok
const DWORD fakeHsAddr = 0x00D86BA8;//ok
const DWORD KO_HWND = 	0x00C21944;
BYTE ORJCODE[10];
DWORD my_tid;
...
my_tid = GetCurrentThreadId();
		baypas();
	   HWND	hGameHWND = (HWND)*(DWORD*)KO_HWND;
	   MoveWindow(hGameHWND,0,0,500,400,1);
